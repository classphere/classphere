...
exports.MAX_INTERVAL_DAYS = exports.MAX_EASE = exports.MIN_EASE = exports.PASS_ACCURACY = void 0;
exports.accuracyToQuality = accuracyToQuality;
exports.scheduleNextReview = scheduleNextReview;
exports.seedFromAttempt = seedFromAttempt;
exports.initialState = initialState;
/** A review is judged passed at or above this accuracy. */
exports.PASS_ACCURACY = 60;
/** SM-2's floor. Below this, intervals stop growing meaningfully. */
exports.MIN_EASE = 1.3;
exports.MAX_EASE = 2.8;
/**
 ...
 */
function accuracyToQuality(accuracyPct) {
 ...
 */
function scheduleNextReview(state, accuracyPct, now = new Date()) {
    const quality = accuracyToQuality(accuracyPct);
    const passed = accuracyPct >= exports.PASS_ACCURACY;
    ...
    const ease = clamp(state.ease + easeDelta, exports.MIN_EASE, exports.MAX_EASE);
    if (!passed) {
    ...
    intervalDays = clamp(intervalDays, 1, exports.MAX_INTERVAL_DAYS);
    return {
        intervalDays,
        ease,
        repetitions,
 ...
 */
function seedFromAttempt(accuracyPct, now = new Date()) {
    const accuracy = clamp(accuracyPct, 0, 100);
    const ease = clamp(2.5 + (0.1 - (5 - accuracyToQuality(accuracy)) * 0.08), exports.MIN_EASE, exports.MAX_EASE);
    // Weak topics return tomorrow, shaky ones in a few days, solid ones after a week.
    const intervalDays = accuracy < exports.PASS_ACCURACY ? 1 : accuracy < 85 ? 3 : 7;
    return {
        intervalDays,
        ease,
        // Counts as one successful review only if they actually passed it.
        repetitions: accuracy >= exports.PASS_ACCURACY ? 1 : 0,
        lapses: 0,
        dueAt: addDays(now, intervalDays),
        passed: accuracy >= exports.PASS_ACCURACY,
    };
}

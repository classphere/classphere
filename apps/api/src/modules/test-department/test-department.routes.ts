...
import { createDepartmentMember, deactivateDepartmentMember, getReviewPaper, listDepartmentMembers, listReviewPapers, transitionReviewPaper, updateReviewQuestion, validatePaper } from "./test-department.controller";

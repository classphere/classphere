                        ...
                        >
                          ...
                          <div className="relative w-full h-[42px] flex flex-col justify-end items-center shrink-0">
                            {isSelected && (
                              <div className="absolute bottom-0 flex flex-col items-center animate-in fade-in slide-in-from-bottom-2 duration-150">
                                ...
                                {/* Indicator Dot */}
                                <div className="size-3 bg-b-surface2 border-[3px] border-primary-02 rounded-full mt-2" />
                              </div>
                            )}
                          </div>
                          ...
                          <div 
                            ...
                            className={`w-full rounded-lg transition-all ${
                              isSelected 
                                ? "bg-gradient-to-t from-primary-02 to-[#00d16c] shadow-[0_0_12px_rgba(0,166,86,0.35)]" 
                                : "bg-primary-02/10 dark:bg-white/5 group-hover/bar:bg-primary-02/20 dark:group-hover/bar:bg-white/10 border border-primary-02/10 dark:border-white/5"
                            }`}
                          />
                        </div>
                      );

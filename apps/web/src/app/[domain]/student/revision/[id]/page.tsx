...
export default function RevisionPracticePage() {
  ...
  if (!questions.length) return <><Navbar title="Revision Practice" /><div className="mx-auto max-w-xl px-6 py-20 text-center"><p className="font-semibold text-t-primary">No suitable questions are available for this topic yet.</p><button onClick={() => router.push("/student/mistakes")} className="mt-5 text-sm font-bold text-primary-01">Back to Mistake Diary</button></div></>;
  ...
  return (
    <>
      ...
      <main className="mx-auto w-full max-w-4xl space-y-5 px-4 pb-12 pt-4 md:px-6">

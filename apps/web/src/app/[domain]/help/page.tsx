      ...
      <main className="mx-auto flex w-full max-w-[1000px] flex-col gap-10 px-6 pb-16 pt-6">
        ...
        <div className="relative w-full max-w-[600px] mx-auto mb-4">
          ...
          <input 
            ...
            className="w-full h-14 pl-12 pr-4 bg-b-surface2 dark:bg-b-surface2 border border-[#e5e5e5]/40 dark:border-[#272727]/40 rounded-[12px] text-[15px] text-t-primary dark:text-t-primary placeholder:text-t-secondary focus:border-t-primary dark:focus:border-t-primary outline-none transition-colors dark:shadow-velora-dark"
            value={searchQuery}

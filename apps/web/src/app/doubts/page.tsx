...
export default function StudentChatPage() {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-[#F9F9F9] dark:bg-b-surface1/60">
      ...
      <main className="flex-1 p-6 flex items-center justify-center bg-[#F9F9F9] dark:bg-b-surface1/40 select-none overflow-y-auto">

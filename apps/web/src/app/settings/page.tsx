    ...
    <>
      ...
      <main className="mx-auto flex w-full max-w-[1400px] flex-col gap-8 px-6 pb-16 pt-6 xl:flex-row xl:items-start">
        ...
        <div className="flex-1 flex flex-col gap-8 min-w-0">
          ...
          <div className="card flex flex-col p-8 rounded-lg bg-[#FDFDFD] dark:bg-b-surface2 shadow-[0px_5px_1.5px_-4px_rgba(8,8,8,0.09),0px_6px_4px_-4px_rgba(8,8,8,0.05)] border border-s-stroke2/40">
            ...
            {activeTab === "general" && (
              <div className="flex flex-col animate-in fade-in duration-300">
                ...
                <div className="flex items-center gap-6 mb-10">
                  ...
                  <button className="flex items-center gap-2 h-10 px-5 rounded-lg bg-[#F9F9F9] dark:bg-b-surface1 border border-s-stroke2/40 text-[13px] font-bold text-[#101010] dark:text-t-primary hover:bg-[#EAEAEA] dark:hover:bg-s-stroke2/30 transition-colors shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  <div className="flex flex-col gap-2">
                    ...
                    <input type="text" className="w-full h-12 px-4 bg-[#F9F9F9] dark:bg-b-surface1 border border-s-stroke2/40 rounded-lg text-[15px] font-medium text-[#101010] dark:text-t-primary focus:border-[#101010] dark:focus:border-t-primary outline-none transition-colors shadow-inner" defaultValue={role === "teacher" ? "Aman Sir" : "Harsh Singh"} />
                  </div>
                  <div className="flex flex-col gap-2">
                    <label className="text-[13px] font-semibold text-[#7B7B7B] uppercase tracking-[0.02em]">Email Address</label>
                    <input type="email" className="w-full h-12 px-4 bg-[#F9F9F9] dark:bg-b-surface1 border border-s-stroke2/40 rounded-lg text-[15px] font-medium text-[#101010] dark:text-t-primary focus:border-[#101010] dark:focus:border-t-primary outline-none transition-colors shadow-inner" defaultValue={role === "student" ? "harshsingh15dec@gmail.com" : "admin@institute.com"} />
                  </div>
                </div>
                ...
                {role === "student" && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div className="flex flex-col gap-2">
                      ...
                      <select className="w-full h-12 px-4 bg-[#F9F9F9] dark:bg-b-surface1 border border-s-stroke2/40 rounded-lg text-[15px] font-medium text-[#101010] dark:text-t-primary focus:border-[#101010] dark:focus:border-t-primary outline-none transition-colors shadow-inner appearance-none">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <input type="text" className="w-full h-12 px-4 bg-[#F9F9F9] dark:bg-b-surface1 border border-s-stroke2/40 rounded-lg text-[15px] font-medium text-[#101010] dark:text-t-primary focus:border-[#101010] dark:focus:border-t-primary outline-none transition-colors shadow-inner" defaultValue="Focusing on Physics and Maths" />
                    </div>
                  </div>
                )}
                ...
                {role === "teacher" && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <input type="text" className="w-full h-12 px-4 bg-[#F9F9F9] dark:bg-b-surface1 border border-s-stroke2/40 rounded-lg text-[15px] font-medium text-[#101010] dark:text-t-primary outline-none" defaultValue="Senior Faculty" readOnly />
                    </div>
                  </div>
                )}
                ...
                {role === "institute_admin" && (
                  <div className="grid grid-cols-1 gap-6 mb-8">
                    <div className="flex flex-col gap-2">
                      ...
                      <input type="text" className="w-full h-12 px-4 bg-[#F9F9F9] dark:bg-b-surface1 border border-s-stroke2/40 rounded-lg text-[15px] font-medium text-[#101010] dark:text-t-primary focus:border-[#101010] dark:focus:border-t-primary outline-none transition-colors shadow-inner" defaultValue="Vibrant Academy" />
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="flex flex-col animate-in fade-in duration-300">
                ...
                <div className="flex flex-col gap-8">
                  ...
                  <div className="flex items-start justify-between pb-4">
                    ...
                    <button className="h-10 px-5 rounded-lg bg-red-50 dark:bg-[rgba(239,68,68,0.1)] border border-[rgba(239,68,68,0.2)] text-[13px] font-bold text-[#EF4444] hover:bg-red-100 transition-colors shadow-sm shrink-0">
                      Revoke All
                    </button>
                  </div>
                </div>
            ...
            {activeTab === "billing" && role === "institute_admin" && (
              <div className="flex flex-col animate-in fade-in duration-300">
                ...
                <div className="p-6 bg-[#F9F9F9] dark:bg-b-surface1 border border-s-stroke2/40 rounded-lg mb-8 flex justify-between items-center">
                  <div>
                ...
                <button className="h-12 px-6 rounded-lg bg-[#101010] dark:bg-t-primary text-[#FDFDFD] dark:text-b-surface1 text-[14px] font-bold hover:bg-[#202020] transition-colors shadow-sm self-start">
                ...
                <div className="grid grid-cols-1 gap-6 mb-8">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-lg bg-[#0A84FF] shadow-sm border border-s-stroke2/20"></div>
                      <input type="text" className="w-40 h-12 px-4 bg-[#F9F9F9] dark:bg-b-surface1 border border-s-stroke2/40 rounded-lg text-[15px] font-bold text-[#101010] dark:text-t-primary outline-none uppercase tracking-widest" defaultValue="#0A84FF" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-8 pt-8 border-t border-s-stroke2/30 flex items-center justify-end gap-4">
              <button className="h-12 px-6 rounded-lg text-[#7B7B7B] hover:bg-[#F9F9F9] dark:hover:bg-b-surface1 hover:text-[#101010] dark:hover:text-t-primary transition-colors text-[14px] font-semibold cursor-pointer">
                Discard Changes
              </button>
              <button 
                className={`h-12 px-8 rounded-lg text-[#FDFDFD] dark:text-b-surface1 text-[14px] font-bold transition-all shadow-sm active:scale-[0.98] cursor-pointer flex items-center justify-center min-w-[160px] ${

      ...
      <main className="mx-auto w-full max-w-[1560px] flex flex-col items-center pb-12 pt-6 gap-6 px-6 bg-transparent">
        ...
        <div className="w-full flex flex-col items-start gap-6 mt-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
            ...
            {/* Starter Plan */}
            <div className="group relative card flex flex-col overflow-hidden p-6 md:p-8 rounded-[32px] bg-[#FDFDFD] dark:bg-b-surface2 shadow-[0px_5px_1.5px_-4px_rgba(8,8,8,0.09),0px_6px_4px_-4px_rgba(8,8,8,0.05)] border-t-[6px] border-t-[#7B7B7B] border border-s-stroke2/40 w-full">
              <div className="box-hover" />
              <div className="relative z-10 flex flex-col items-start w-full">
                <div className="flex flex-row justify-between items-center w-full mb-6">
                  <h3 className="font-sans text-[22px] font-semibold text-[#101010] dark:text-t-primary">Starter Plan</h3>
                  <div className="flex items-center px-3 py-1 rounded-full bg-[#F9F9F9] dark:bg-b-surface1 border border-s-stroke2/40">
                ...
                <button className="mt-auto w-full py-3 rounded-xl border border-s-stroke2/40 bg-[#F9F9F9] dark:bg-b-surface1 hover:bg-[#EAEAEA] dark:hover:bg-s-stroke2/30 transition-colors font-sans text-[15px] font-semibold text-[#101010] dark:text-t-primary">
                  Edit Tier
                </button>
              </div>
            </div>
            ...
            {/* Pro Plan */}
            <div className="group relative card flex flex-col overflow-hidden p-6 md:p-8 rounded-[32px] bg-[#FDFDFD] dark:bg-b-surface2 shadow-[0px_5px_1.5px_-4px_rgba(8,8,8,0.09),0px_6px_4px_-4px_rgba(8,8,8,0.05)] border-t-[6px] border-t-[#2A85FF] border border-s-stroke2/40 w-full scale-[1.02] z-10 shadow-xl">
              <div className="box-hover" />
              <div className="relative z-10 flex flex-col items-start w-full">
                <div className="flex flex-row justify-between items-center w-full mb-6">
                  <h3 className="font-sans text-[22px] font-semibold text-[#101010] dark:text-t-primary">Pro Plan</h3>
                  <div className="flex items-center px-3 py-1 rounded-full bg-[rgba(42,133,255,0.1)] border border-[rgba(42,133,255,0.2)]">
                ...
                <button className="mt-auto w-full py-3 rounded-xl bg-[#101010] hover:bg-[#202020] dark:bg-[#FDFDFD] dark:hover:bg-[#EAEAEA] text-[#FDFDFD] dark:text-[#101010] transition-colors font-sans text-[15px] font-semibold">
                  Edit Tier
                </button>
              </div>
            </div>
            ...
            {/* Enterprise Plan */}
            <div className="group relative card flex flex-col overflow-hidden p-6 md:p-8 rounded-[32px] bg-[#FDFDFD] dark:bg-b-surface2 shadow-[0px_5px_1.5px_-4px_rgba(8,8,8,0.09),0px_6px_4px_-4px_rgba(8,8,8,0.05)] border-t-[6px] border-t-[#8F5BFF] border border-s-stroke2/40 w-full">
              <div className="box-hover" />
              <div className="relative z-10 flex flex-col items-start w-full">
                <div className="flex flex-row justify-between items-center w-full mb-6">
                  <h3 className="font-sans text-[22px] font-semibold text-[#101010] dark:text-t-primary">Enterprise</h3>
                  <div className="flex items-center px-3 py-1 rounded-full bg-[rgba(143,91,255,0.1)] border border-[rgba(143,91,255,0.2)]">
        ...
        {/* ── Recent Transactions ── */}
        <div className="group relative card flex flex-col overflow-hidden p-6 md:p-8 rounded-[32px] bg-[#FDFDFD] dark:bg-b-surface2 shadow-[0px_5px_1.5px_-4px_rgba(8,8,8,0.09),0px_6px_4px_-4px_rgba(8,8,8,0.05)] border border-s-stroke2/40 w-full select-none mt-4">
          <div className="box-hover" />
          ...
          <div className="relative z-10 flex flex-row justify-between items-center w-full mb-6">
            ...
            <button className="flex flex-row items-center gap-2 px-4 py-2 rounded-xl bg-[#F9F9F9] dark:bg-b-surface1 border border-s-stroke2/40 hover:bg-[#EAEAEA] dark:hover:bg-s-stroke2/30 transition-colors">

  ...
  return (
    <main className="mx-auto w-full max-w-[1560px] px-6 pb-12 pt-6 flex flex-col gap-6 select-none bg-transparent">
      ...
      <div className="flex flex-col gap-6 w-full max-w-[900px] mt-4">
        ...
        {/* Basic Details */}
        <section className="group relative flex flex-col p-6 md:p-8 gap-6 bg-white dark:bg-white/[0.02] border border-s-stroke2/40 rounded-[24px] shadow-velora-light w-full transition-all duration-300">
          <h2 className="font-sans font-bold text-[20px] text-t-primary dark:text-t-primary flex items-center gap-2">
        ...
        <div className="flex justify-end gap-3 mt-2">
          <Link href="/institute" className="btn btn-outline h-12 px-6 rounded-[10px] text-sm font-semibold flex items-center">
            Cancel
          </Link>
          <Link href="/institute" className="btn btn-primary h-12 px-6 rounded-[10px] text-sm font-semibold flex items-center gap-2 shadow-[0px_4px_12px_rgba(42,133,255,0.25)]">

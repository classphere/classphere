    ...
    <>
      <main className="mx-auto w-full max-w-[1560px] px-6 pb-12 pt-6 flex flex-col gap-6 select-none bg-transparent">
        ...
        <div className="flex flex-row justify-between items-center mt-2 w-full">
          ...
          <button 
            className="btn btn-primary h-12 px-6 rounded-[10px] text-sm font-semibold flex items-center gap-2 cursor-pointer shadow-[0px_4px_12px_rgba(42,133,255,0.25)]" 
        ...
        {showNewTicket && (
          <div className="group relative w-full bg-white dark:bg-white/[0.02] border border-s-stroke2/40 rounded-[24px] overflow-hidden mt-4 shadow-velora-light transition-all duration-300 animate-in slide-in-from-top-4 fade-in">
        ...
        <div className="group relative flex flex-col p-6 md:p-8 gap-6 bg-white dark:bg-white/[0.02] border border-s-stroke2/40 rounded-[24px] shadow-velora-light w-full min-w-0 overflow-hidden select-none mt-2 transition-all duration-300">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-row items-center gap-5 flex-1 min-w-0 overflow-hidden">
                    <div className={`flex w-16 h-16 items-center justify-center rounded-[10px] shrink-0 ${iconBgClass}`}>

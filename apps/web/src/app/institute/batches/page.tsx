  ...
  return (
    <main className="mx-auto w-full max-w-[1560px] px-6 pb-12 pt-6 flex flex-col gap-6 select-none bg-transparent">
      ...
      <div className="flex flex-col gap-2 mt-6">
        <h2 className="font-sans font-semibold text-[20px] leading-[145%] text-t-primary dark:text-t-primary">All Batches</h2>
        <p className="text-xs text-t-secondary dark:text-t-tertiary">Configure class cohorts, monitor student enrollment sizes, and assign lecturing faculty.</p>
      </div>
